...
public class AdminEventsPage {
    ...
    private static final String TOTAL_SEAT_LABEL = "Total Seats";
    ...
    public void createEvent(String title,String description,String category,String city,String venue,String dateTime,String price,String totalSeats){
        page.locator(EVENT_TITLE_INPUT).fill(title); // when we don't find any right locator matching to find out the component on the web, then use page.locator and here we can provide either xpath or CSS in ""
        page.locator(DESCRIPTION_TEXTAREA).fill(description);  // here we use custom CSS i.e. from parent to child. syntax is : #ParentID childTag
        ...
        page.getByLabel(TOTAL_SEAT_LABEL).fill(totalSeats);
